...
if(isset($_POST['btn'])) 
{
	...
	{
	 $qry="select * from  add_rural_head where uname='$uname' and  pass='$password'";
...
<body>
            ...
            <div class="container-fluid px-lg-5">
                ...
                <nav>
                    ...
                    <ul class="menu">
                        ...
                        <li class="mr-lg-4 mr-3 active"><a href="officer_login.php">Officer</a></li>
                    </ul>
                </nav>
                <!-- //nav -->
                <!-- //nav -->
    ...
    <!--/ab -->
                ...
                <h3  align="center">Officer Login Now</h3>
