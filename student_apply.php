                ...
                <nav>
                    ...
                    <ul class="menu">
                       <li class="mr-lg-4 mr-3 "><a href="student_home.php">Home</a></li>
                        ...
                        <li class="mr-lg-4 mr-3 active"><a href="student_apply.php">Apply Status</a></li>
    ...
    <!--/ab width="900" height="100"-->
                ...
                <form action="#" method="post">
                  ...
                  <table class="table" border="0" align="center">
                    <tr>
					<th class="table-primary"><strong>Username</strong></th>
                      <th class="table-primary"><strong>Category</strong></th>
                      <th class="table-primary"><strong>Scheme Name</strong></th>
                      <th class="table-primary"><strong>Time Limit</strong></th>
                      <th class="table-primary"><strong>Photo</strong></th>
                      <th class="table-primary"><strong>Status</strong></th> 
					 
                    </tr>
					 <?php
				 
				  $qry="select * from  user_apply where username='$name'";
				$result = mysqli_query($conn, $qry);
